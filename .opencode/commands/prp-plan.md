...
Write the full plan document using the template below. Save to `.opencode/PRPs/plans/{kebab-case-feature-name}.plan.md`.

Create the directory if it doesn't exist:
```bash
mkdir -p .opencode/PRPs/plans
```
...
```
.opencode/PRPs/plans/{kebab-case-feature-name}.plan.md
```
...
- **File**: .opencode/PRPs/plans/{kebab-case-feature-name}.plan.md
- **Source PRD**: [path or "N/A"]
...
> Next step: Run `/prp-implement .opencode/PRPs/plans/{name}.plan.md` to execute this plan.
```
