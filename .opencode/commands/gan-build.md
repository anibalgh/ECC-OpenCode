...
1. Launch the `gan-planner` agent via subagent tool with the user's brief
...
while iteration <= max_iterations:
    ...
    # GENERATE
    Launch gan-generator agent via subagent tool:
    - Read spec.md
    ...
    # EVALUATE
    Launch gan-evaluator agent via subagent tool:
